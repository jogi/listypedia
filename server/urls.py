...
urlpatterns = patterns('',
    ...
    url(r'^list/unfollow/', 'server.views.remove_follower', name='remove_follower'),
    ...
    url(r'^list/(?P<slug>[a-zA-Z0-9_.-]+)/item/remove/', 'server.views.remove_item', name='remove_item'),
